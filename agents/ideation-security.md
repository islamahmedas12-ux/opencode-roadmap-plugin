---
description: Security Hardening ideation agent. Analyzes the codebase and produces security_hardening_ideas.json with up to N actionable ideas. Invoked by /ideation.
mode: subagent
permission:
  edit: deny
  bash: allow
...
- **Output File**: the exact path for your JSON output (`<output_dir>/security_hardening_ideas.json`)
