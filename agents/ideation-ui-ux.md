---
description: UI/UX Improvements ideation agent. Analyzes the codebase and produces ui_ux_improvements_ideas.json with up to N actionable ideas. Invoked by /ideation.
mode: subagent
permission:
  edit: deny
  bash: allow
...
- **Output File**: the exact path for your JSON output (`<output_dir>/ui_ux_improvements_ideas.json`)
